...
whenever(Backspace, (value) => {
	if (value && selected.value && store.not_using_input && store.allow_tabs) {
...
<template>
	<div class="tab-header" v-if="store.form.layout.tabs.length > 1">
		...
		<div class="tab-actions" :hidden="store.read_only || !store.allow_tabs">
			<button
	...
	<div class="tab-contents">
		...
		>
			...
			<div class="empty-tab" :hidden="store.read_only || !store.allow_layout_edits">
